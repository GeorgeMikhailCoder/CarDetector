...
% Функция группирует центры по радиусу R. Точки попарно перебираются, те, у
% которых расстояние меньше радиуса объединяются в группу. 
% Функция возвращает:
% resMeans - центры масс (среднее арифметическое) группы
% resObjectPoints - сами группы
